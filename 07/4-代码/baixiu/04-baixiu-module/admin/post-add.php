...
<body>
      ...
      <form class="row" action="./post/postAdd.php" method="post" enctype="multipart/form-data">
        <div class="col-md-9">
          ...
          <div class="form-group">
            ...
            <textarea id="content" class="form-control input-lg" name="content" cols="30" 
             rows="10" placeholder="内容" style="display:none;"></textarea>
             <!-- 富文本编辑器 容器 -->
  ...
  <script>
    ...
    // 监控富文本编辑内容的变化，同步更新到 textarea
    editor.customConfig.onchange = function (html) {
        //获取富文本编辑器的内容，设置textarea 
        //参数html 就是富文本编辑器中 当前内容       
        $('#content').val(html);
