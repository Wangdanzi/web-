...
<body>
  ...
  <script>
    ...
    //2-添加分类：
    //1-点击添加按钮，获取表单数据，提交给后台
    //2-后台获取分类的数据，添加到数据库中
    //3-后台添加完成，重新渲染页面
    $('.btn-add').click(function () {
      //获取表单数据
      //1-FromData  2-表单序列化 serialize();
    ...
    //4-修改分类
    //1-点击编辑按钮，获取当前数据id，去后台获取对应的数据，将数据填充在页面上，供用户修改
    //2-修改完成后，点击保存按钮，获取修改后的数据，将数据更新回数据库， 
    //3-页面重新渲染 
